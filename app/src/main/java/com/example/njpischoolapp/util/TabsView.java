...
public class TabsView extends LinearLayout {
    ...
    private int mSelectedColor = 0xffFFA500;// 选中的字体颜色
    private int mNotSelectedColor = ((mSelectedColor >>> 25) << 24) | (mSelectedColor & 0x00000000);// 未选中的字体颜色

//    private int mIndicatorColor = 0xffD3D3D3;// 指示器的颜色
